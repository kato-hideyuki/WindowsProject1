...
Cube::Cube()
{
   m_vertices[0]  = { -0.5f,  0.5f, -0.5f,  1.0f, 0.0f, 0.0f, 1.0f  };
   m_vertices[1]  = {  0.5f,  0.5f, -0.5f,  1.0f, 0.0f, 0.0f, 1.0f  };
   m_vertices[2]  = { -0.5f, -0.5f, -0.5f,  1.0f, 0.0f, 0.0f, 1.0f  };
   m_vertices[3]  = {  0.5f, -0.5f, -0.5f,  1.0f, 0.0f, 0.0f, 1.0f  };
                                                                   
   m_vertices[4]  = { -0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 1.0f, 1.0f  };
   m_vertices[5]  = { -0.5f, -0.5f,  0.5f,  0.0f, 1.0f, 1.0f, 1.0f  };
   m_vertices[6]  = {  0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 1.0f, 1.0f  };
   m_vertices[7]  = {  0.5f, -0.5f,  0.5f,  0.0f, 1.0f, 1.0f, 1.0f  };
                                                                    
   m_vertices[8]  = { -0.5f,  0.5f,  0.5f,  1.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[9]  = { -0.5f,  0.5f, -0.5f,  1.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[10] = { -0.5f, -0.5f,  0.5f,  1.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[11] = { -0.5f, -0.5f, -0.5f,  1.0f, 1.0f, 0.0f, 1.0f  };
                                                                     
   m_vertices[12] = {  0.5f,  0.5f,  0.5f,  0.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[13] = {  0.5f, -0.5f,  0.5f,  0.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[14] = {  0.5f,  0.5f, -0.5f,  0.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[15] = {  0.5f, -0.5f, -0.5f,  0.0f, 0.0f, 1.0f, 1.0f  };
                                                                     
   m_vertices[16] = { -0.5f,  0.5f,  0.5f,  1.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[17] = {  0.5f,  0.5f,  0.5f,  1.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[18] = { -0.5f,  0.5f, -0.5f,  1.0f, 0.0f, 1.0f, 1.0f  };
   m_vertices[19] = {  0.5f,  0.5f, -0.5f,  1.0f, 0.0f, 1.0f, 1.0f  };
                                                                     
   m_vertices[20] = { -0.5f, -0.5f,  0.5f,  0.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[21] = { -0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[22] = {  0.5f, -0.5f,  0.5f,  0.0f, 1.0f, 0.0f, 1.0f  };
   m_vertices[23] = {  0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 0.0f, 1.0f  };
}
